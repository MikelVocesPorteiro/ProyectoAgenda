package com.example.ProyectoAgenda.controller;
...
import com.example.ProyectoAgenda.servicios.categoria.CategoriaServicios;
import com.example.ProyectoAgenda.servicios.departamento.DepartamentoServicios;
import com.example.ProyectoAgenda.servicios.empleado.EmpleadoServicios;
import com.example.ProyectoAgenda.servicios.persona.PersonaServicios;
import com.example.ProyectoAgenda.servicios.persona.PersonaServiciosImpl;
...
public class HomeController {
    ...
    /*
	@Autowired
	private EmpleadoServicios empServicios;
	@Autowired
	private DepartamentoServicios dptoServicios;
	@Autowired
	private CategoriaServicios categServicios;
	@Autowired
...
*/
	...
	public ModelAndView handleRequest() throws Exception {
    	...
    	PersonaServiciosImpl personaServicios = new PersonaServiciosImpl();
    	
    	List<Persona> listper = personaServicios.list();
		ModelAndView model = new ModelAndView("PerList");
		model.addObject("listaPersona", listper);
